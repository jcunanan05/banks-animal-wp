...
function wp_bootstrap_main_nav() {
  ...
  wp_nav_menu(
    array(
      ...
      'menu_class' => 'list-unstyled main-navigation',
...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed by <a href="#" target="_blank">Vets & Pets</a></span></a>.';
}
...
// Custom thumbnails
add_image_size( 'bh_400x250', 400, 250, true);
add_image_size( 'bh_400x300', 400, 300, true);
add_image_size( 'bh_banner-home', 1920, 700, true);
...
//        wp_enqueue_style( 'wpbs' );
        ...
        // For child themes
        wp_register_style( 'bh-style', get_stylesheet_directory_uri() . '/library/dist/css/style.min.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'bh-style' );
    }
}
...
if( !function_exists( "wp_bootstrap_theme_js" ) ) {
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'mg-js',
      get_template_directory_uri() . '/library/dist/js/magnific.js',
      array('bootstrap'),
      '1.2' );

    wp_register_script( 'mmenu-js',
      get_template_directory_uri() . '/library/dist/js/mmenu.all.min.js',
      array('bootstrap'),
      '1.2' );

    wp_register_script( 'flickity-js',
      get_template_directory_uri() . '/library/dist/js/flickity.carousel.min.js',
      array('bootstrap'),
      '1.2' );

    wp_register_script( 'bh-js',
      get_template_directory_uri() . '/library/dist/js/applications.min.js',
      array('bootstrap'),
      '1.2' );
...
//AMP support
add_action( 'amp_init', 'amp__blog' );
function amp__blog() {
  add_post_type_support( 'our-blog', AMP_QUERY_VAR );
}


add_action( 'amp_init', 'amp__team' );
function amp__team() {
  add_post_type_support( 'our-team', AMP_QUERY_VAR );
}
?>
